...
<head>
	...
	<link rel="stylesheet" href="other styles/editprofile.css">
</head>
				...
				<div class="inline-2">
					...
					<div>
						...
						<input type="text" id="whatsapp" name="whatsapp"
							value="<?php echo htmlspecialchars($whatsapp); ?>" placeholder="WhatsApp Number" required>
					</div>
				</div>
				<div class="inline-2">
					<div>
						...
						<input type="text" id="guardian-contact" name="guardiancontact"
							placeholder="Guardian Contact Number" value="<?php echo htmlspecialchars($gaurdiannum); ?>"
							required>
					</div>
					<div>
						<label for="student-image">Upload Student Image</label>
						<input type="file" id="student-image" disabled value="<?php echo htmlspecialchars($image); ?>"
							name="student_image" accept="image/*" required>
					</div>
				</div>
