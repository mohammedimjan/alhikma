...
<head>
	...
	<link rel="stylesheet" href="other styles/profile.css">
</head>
			...
			<div class="profile-table">
				<table id="profile">
					...
					<tr>
						...
						<td><?php echo htmlspecialchars($gaurdiannum); ?></td>
					</tr>
				</table>
				<div class="profile-change-btn">
					<?php 
					echo "
					<a href='changepassword.php?id=$id' class='download-button'>Change Password</a>
					";
					?>
				</div>
			</div>
